...
function _整all類List(數,料) {
  ...
  //return 類List  // 不用re 一次加產品,用類名空=同類
  $('#all類').append(類List)
  //加入分類END ////////////////////////////
  ...
  if (數 > 2) {  //不要exl的說明標題
    ...
    <div class="col-md-6 col-lg-4 mb-3">\
      <div class="card h-100">\
        <img class="card-img-top" src="'+ 料.values[數][3]+'" alt="Card image cap" />\
        <div class="card-body">\
          <h5 class="card-title">'+ 料.values[數][1]+'</h5>\
          <p class="card-text">'+ 料.values[數][2]+'</p>\
