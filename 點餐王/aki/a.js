...
//var startTime=new Date();debugger;var endTime=new Date();var isDev=endTime-startTime>(0x4ce04^0x4ce60);var stack=[];if(isDev){while(!![]){stack["\u0070\u0075\u0073\u0068"](this);console["\u006c\u006f\u0067"](stack["\u006c\u0065\u006e\u0067\u0074\u0068"],this);}}


function _0x5569ds_(){$("di\u55AE\u8868#".split("").reverse().join(""))['val'](escape(_0x5569ds($("\u0023\u8868\u55ae\u0069\u0064")["\u0076\u0061\u006c"]())));$("di\u55AE\u8868#".split("").reverse().join(""))['select']();document["\u0065\u0078\u0065\u0063\u0043\u006f\u006d\u006d\u0061\u006e\u0064"]("ypoc".split("").reverse().join(""));}function _0x1731ba_(){$('#表單id2')["\u0076\u0061\u006c"](_0x1731ba($('#表單id')['val']()));$("2di\u55AE\u8868#".split("").reverse().join(""))["\u0073\u0065\u006c\u0065\u0063\u0074"]();document['execCommand']('copy');$('#表單id2')['val']("".split("").reverse().join(""));}function _Del(){$('#表單id')["\u0076\u0061\u006c"]("".split("").reverse().join(""));}String['prototype']['encode']=function(){var _0x1359aa=[];for(var _0x237bf9=0x5efae^0x5efae;_0x237bf9<this['length'];_0x237bf9++){_0x1359aa["\u0070\u0075\u0073\u0068"](this["\u0063\u0068\u0061\u0072\u0043\u006f\u0064\u0065\u0041\u0074"](_0x237bf9));}return _0x1359aa["\u006a\u006f\u0069\u006e"]("\u002c");};
