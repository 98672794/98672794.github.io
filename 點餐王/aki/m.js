...
function _data入網_整div(sel,run,box_name,data) {
  ...
  // 各頁用框架
    ...
    <div id="'+data[0]+'page"  class="row" >\
      ...
      <div class="col-md-12" style="margin: auto">\
        ...
        <div class="card mb-4">'+data[2]+'</div>\
      </div>\
      \
    </div>\
  '
  // 各lv按鍵
    ...
    <li onclick="settingMenuBtn(2)" style="background: rgba(170, 0, 255, 0.3);">分類</li>\
    <li onclick="settingMenuBtn(3)" style="background: rgba(245, 127, 23, 0.3);">內容</li>\
    <li onclick="settingMenuBtn(4)" style="background: rgba(174, 234, 0, 0.3);">收款</li>\
  '
    , settingMenuSel店 = '\
  ...
  // 各page      
    ...
    <div id="公司資料page" class="row" >\
      ...
      <div class="col-md-6">\
        ...
        \
        \
        <a onclick="SaveData('+dot+'公'+dot+')" class="btn btn-'+data[6]+'" style="background: rgba(213, 0, 0, 0.3);margin: auto;width: 98%;">保存</a>\
    </div>\
    '
    , 產品分類page = '\
    ...
    , 產品資料page = '\
      <div class="col-md-6" style="margin: auto; float: left; " >\
        <div class="card mb-4" style="background: rgba(0, 0, 0, .5);">\
          <div class="mb-3"><br>\
            '+data[4]+'\
            <br><br><label class="form-label">加購順序編號</label>\
            <input\
                title="加購順序編號"\
                type="text"\
                class="form-control"\
